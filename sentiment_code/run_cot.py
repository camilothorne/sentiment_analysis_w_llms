...
'''
In this file, we reproduce one of methods (M5 - CoT learning) 
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename = os.path.join(dirname, '../results/log-cot.log'), 
